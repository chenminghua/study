package ramq.service.impl;

import ramq.config.RabbitMQConfig;
...
public class ProductServiceImpl implements ProductService, RabbitTemplate.ConfirmCallback {
    ...
    public void save(Product product) {
        ...
        rabbitTemplate.convertAndSend(RabbitMQConfig.EXCHANGE, RabbitMQConfig.ROUTINGKEY, product, correlationId);
    }
}
